...
(() => {
  ...
  var hideModeCodes = ["default", "overlay", "collapse"];
  ...
  var HideModeItem = ({ index, hideMode }) => {
    ...
    return /* @__PURE__ */ _("div", { className: "hide-comment hide-mode-item" + classHideName }, randomContent, hideMode === "default" && /* @__PURE__ */ _("div", { className: "hide-comment-content hide-comment-content-default" }, /* @__PURE__ */ _("span", { className: "hide-comment-content-handler", onClick: handleDismiss }, /* @__PURE__ */ _("i", { className: "gg-eye" }))), hideMode === "overlay" && /* @__PURE__ */ _("div", { className: "hide-comment-content hide-comment-content-overlay" }, /* @__PURE__ */ _("span", { className: "hide-comment-content-handler", onClick: handleDismiss }, /* @__PURE__ */ _("i", { className: "gg-eye" })), /* @__PURE__ */ _("div", { className: "hide-comment-overlay-content" }, /* @__PURE__ */ _("div", { className: "hide-comment-content-brief" }, /* @__PURE__ */ _("span", { className: "hide-comment-content-user" }, "User 2"), /* @__PURE__ */ _("span", { className: "hide-comment-content-date" }, date), /* @__PURE__ */ _("span", { className: "hide-comment-content-minus" }, "-", randomMinus), "|", /* @__PURE__ */ _("span", { className: "hide-comment-content-plus" }, "+", randomPlus)))), hideMode === "collapse" && /* @__PURE__ */ _("div", { className: "hide-comment-content hide-comment-content-collapse" }, /* @__PURE__ */ _("div", { className: "hide-comment-content-brief" }, /* @__PURE__ */ _("span", { className: "hide-comment-content-handler", onClick: handleDismiss }, /* @__PURE__ */ _("i", { className: "gg-eye" })), /* @__PURE__ */ _("span", { className: "hide-comment-content-user" }, "User 2"), /* @__PURE__ */ _("span", { className: "hide-comment-content-date" }, date), /* @__PURE__ */ _("span", { className: "hide-comment-content-minus" }, "-", randomMinus), "|", /* @__PURE__ */ _("span", { className: "hide-comment-content-plus" }, "+", randomPlus))), /* @__PURE__ */ _("div", { className: "hide-mode-item-footer" }, /* @__PURE__ */ _("span", { className: "user" }, "User ", index), /* @__PURE__ */ _("span", { className: "time" }, date), /* @__PURE__ */ _("span", { className: "icons" }, /* @__PURE__ */ _("i", null), /* @__PURE__ */ _("i", null), /* @__PURE__ */ _("i", null), /* @__PURE__ */ _("i", null)), /* @__PURE__ */ _("span", { className: "karma" }, /* @__PURE__ */ _("span", { className: "karma-minus" }, randomMinus, " ", /* @__PURE__ */ _("b", null)), /* @__PURE__ */ _("span", { className: "karma-plus" }, /* @__PURE__ */ _("b", null), " ", randomPlus))));
  };
  ...
  var HideModeExample = () => {
    y2(() => {
      ...
      const handleCloseDone = (e3) => {
        if (e3.animationName === "close") {
  ...
  var Settings = /* @__PURE__ */ _(SettingsPage, null);
  B(Settings, appContainer);
})();
