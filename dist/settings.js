...
(() => {
  ...
  var HideModeItem = ({ index, hideMode }) => {
    ...
    return /* @__PURE__ */ _("div", { className: "hide-mode-item" + classHideName }, randomContent, hideMode === "overlay" && /* @__PURE__ */ _("div", { className: "hide-comment-overlay-content" }, /* @__PURE__ */ _("div", { className: "hide-comment-content-brief" }, /* @__PURE__ */ _("span", { className: "hide-comment-content-user" }, "User 2"), ",", /* @__PURE__ */ _("span", { className: "hide-comment-content-minus" }, "-", randomMinus), "|", /* @__PURE__ */ _("span", { className: "hide-comment-content-plus" }, "+", randomPlus))), hideMode === "collapse" && /* @__PURE__ */ _("div", { className: "hide-comment-collapse-content" }, /* @__PURE__ */ _("div", { className: "hide-comment-content-brief" }, /* @__PURE__ */ _("span", { className: "hide-comment-content-user" }, "User 2"), ",", /* @__PURE__ */ _("span", { className: "hide-comment-content-minus" }, "-", randomMinus), "|", /* @__PURE__ */ _("span", { className: "hide-comment-content-plus" }, "+", randomPlus))), /* @__PURE__ */ _("div", { className: "hide-mode-item-footer" }, /* @__PURE__ */ _("span", { className: "user" }, "User ", index), /* @__PURE__ */ _("span", { className: "time" }, date), /* @__PURE__ */ _("span", { className: "icons" }, /* @__PURE__ */ _("i", null), /* @__PURE__ */ _("i", null), /* @__PURE__ */ _("i", null), /* @__PURE__ */ _("i", null)), /* @__PURE__ */ _("span", { className: "karma" }, /* @__PURE__ */ _("span", { className: "karma-minus" }, randomMinus, " ", /* @__PURE__ */ _("b", null)), /* @__PURE__ */ _("span", { className: "karma-plus" }, /* @__PURE__ */ _("b", null), " ", randomPlus))));
  };
