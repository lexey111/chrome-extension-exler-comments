...
(() => {
  ...
  var HideMode = () => {
    ...
    return /* @__PURE__ */ _("div", null, /* @__PURE__ */ _("h2", null, /* @__PURE__ */ _(I18n, { code: "hide_mode" })), /* @__PURE__ */ _("fieldset", null, /* @__PURE__ */ _("legend", null, "Select hide mode:"), /* @__PURE__ */ _("div", null, /* @__PURE__ */ _("input", { type: "radio", id: "default", name: "hide_mode", value: "default", checked: true }), /* @__PURE__ */ _("label", { htmlFor: "default" }, "Default (blur)")), /* @__PURE__ */ _("div", null, /* @__PURE__ */ _("input", { type: "radio", id: "collapse", name: "hide_mode", value: "collapse", checked: true }), /* @__PURE__ */ _("label", { htmlFor: "collapse" }, "Collapse")), /* @__PURE__ */ _("div", null, /* @__PURE__ */ _("input", { type: "radio", id: "overlay", name: "hide_mode", value: "overlay", checked: true }), /* @__PURE__ */ _("label", { htmlFor: "overlay" }, "Overlay"))), /* @__PURE__ */ _("details", { className: "hide-mode-settings" }, /* @__PURE__ */ _("summary", { className: "hide-mode-selector" }, /* @__PURE__ */ _(I18n, { code: "preview" })), /* @__PURE__ */ _("div", { className: "hide-mode-example" }, /* @__PURE__ */ _("div", { className: "hide-mode-items" }, /* @__PURE__ */ _(HideModeItem, { index: 1 }), /* @__PURE__ */ _(HideModeItem, { index: 2 }), /* @__PURE__ */ _(HideModeItem, { index: 3 })))));
  };
  ...
  var OnOff = () => {
    ...
    return /* @__PURE__ */ _("div", { className: "switch-container" }, /* @__PURE__ */ _("label", { className: "switch" }, /* @__PURE__ */ _("input", { type: "checkbox", checked: on === true, onChange: toggleOnOffState }), /* @__PURE__ */ _("span", { className: "slider round" })), /* @__PURE__ */ _(I18n, { code: "enable_processing" }));
  };
